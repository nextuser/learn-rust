...
#[tokio::main]
async fn main(){
    const  TEST_URL :&str = "https://images.pexels.com/photos/1562477/pexels-photo-1562477.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260";
    ...
    let app = Router::new()
            ...
            .layer(AddExtensionLayer::new(cache)).into_inner());
    let addr = "127.0.0.1:3000".parse().unwrap();
    print_test_url(TEST_URL);
